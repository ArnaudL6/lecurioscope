...
export const ENIGME_CATS=[
  ...
  {id:'historique',      label:'Historique',          icon:'ðï¸', tag:'Faits & personnages'},
  ...
  {id:'science',         label:'Science',             icon:'âï¸', tag:'PhÃ©nomÃ¨nes & curiositÃ©s'},
  {id:'surprise',        label:'Surprise',            icon:'ð²', tag:"L'inattendu"},
];
export const THEMES=[
  {id:'histoire',label:'Histoire',icon:'ðï¸',tag:'Faits historiques'},
  ...
  {id:'food',label:'Gastronomie',icon:'ð½ï¸',tag:'Histoires de saveurs'},
...
export function updateToggleIcon(){const btn=document.getElementById('dark-toggle');if(!btn)return;btn.textContent=document.documentElement.classList.contains('dark')?'âï¸':'ð';}
