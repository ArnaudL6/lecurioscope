...
export const EDGE_MDM=SB_URL+'/functions/v1/mais-dis-moi';
export const EDGE_EPH=SB_URL+'/functions/v1/ephemeride';
export const EDGE_TDQ=SB_URL+'/functions/v1/tas-dit-quoi';
