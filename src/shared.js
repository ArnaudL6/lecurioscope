...
export const ENIGME_CATS=[
  {id:'enigme_du_jour',  label:'Ãnigme du jour',     icon:'ð®', tag:'La classique'},
  {id:'qui_suis_je',     label:'Qui suis-je ?',       icon:'ð­', tag:'Indices progressifs'},
  {id:'logique',         label:'Logique',             icon:'ð§©', tag:'DÃ©duction & raisonnement'},
  {id:'cryptogramme',    label:'Cryptogramme',        icon:'ð', tag:'Code chiffrÃ©'},
  {id:'historique',      label:'Historique',          icon:'ðÃ¯Â¸Â', tag:'Faits & personnages'},
  {id:'paradoxe',        label:'Paradoxe',            icon:'Ã¢ÂÂ¾Ã¯Â¸Â', tag:'Logique & philosophie'},
  {id:'maths_recreatives',label:'Maths rÃ©crÃ©atives',  icon:'ð¢', tag:'Puzzles numÃ©riques'},
  {id:'science',         label:'Science',             icon:'Ã¢ÂÂÃ¯Â¸Â', tag:'PhÃ©nomÃ¨nes & curiositÃ©s'},
  {id:'surprise',        label:'Surprise',            icon:'ð²', tag:"L'inattendu"},
];
export const THEMES=[
  {id:'histoire',label:'Histoire',icon:'ðÃ¯Â¸Â',tag:'Faits historiques'},
  {id:'science',label:'Science',icon:'ð¬',tag:'DÃ©couvertes & curiositÃ©s'},
  {id:'nature',label:'Nature',icon:'ð¿',tag:'Merveilles du vivant'},
  {id:'insolite',label:'Insolite',icon:'ð­',tag:"L'incroyable du quotidien"},
  {id:'art',label:'Art & Culture',icon:'ð¨',tag:'CrÃ©ations & artistes'},
  {id:'espace',label:'Espace',icon:'ð',tag:"Au-delÃ  de l'atmosphÃ¨re"},
  {id:'sport',label:'Sport',icon:'Ã¢ÂÂ¡',tag:'Exploits & records'},
  {id:'food',label:'Gastronomie',icon:'ð½Ã¯Â¸Â',tag:'Histoires de saveurs'},
  {id:'legendes',label:'LÃ©gendes Urbaines',icon:'ð',tag:'Mythes & rÃ©alitÃ©'},
];
...
export const RANKS=[
  {id:'E', label:'E', title:'NÃ©ophyte',   minXP:0,      color:'#9ca3af', bg:'rgba(156,163,175,.08)', glow:'0 0 16px rgba(156,163,175,.25)'},
  {id:'D', label:'D', title:'Apprenti',   minXP:500,    color:'#60a5fa', bg:'rgba(96,165,250,.08)',  glow:'0 0 16px rgba(96,165,250,.3)'},
  {id:'C', label:'C', title:'Ãrudit',     minXP:1500,   color:'#34d399', bg:'rgba(52,211,153,.08)',  glow:'0 0 16px rgba(52,211,153,.3)'},
  {id:'B', label:'B', title:'Chercheur',  minXP:4000,   color:'#fbbf24', bg:'rgba(251,191,36,.08)',  glow:'0 0 16px rgba(251,191,36,.3)'},
  {id:'A', label:'A', title:'MaÃ®tre',     minXP:10000,  color:'#f97316', bg:'rgba(249,115,22,.1)',   glow:'0 0 20px rgba(249,115,22,.35)'},
  {id:'S', label:'S', title:'Archiviste', minXP:25000,  color:'#a855f7', bg:'rgba(168,85,247,.1)',   glow:'0 0 24px rgba(168,85,247,.45)'},
  {id:'\u2605', label:'\u2605', title:'LÃ©gendaire', minXP:75000,  color:'#ec4899', bg:'rgba(236,72,153,.1)',   glow:'0 0 28px rgba(236,72,153,.5)'},
];
...
export function updateToggleIcon(){const btn=document.getElementById('dark-toggle');if(!btn)return;btn.textContent=document.documentElement.classList.contains('dark')?'Ã¢ÂÂÃ¯Â¸Â':'ð';}

export function setRoute(hash){/* routing par pathname — pas de hash dans les URLs */}
