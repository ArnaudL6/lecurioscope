...
async function answerChallenge(challengeId,answer,correct_answer){
  if(!state.currentUser){showToast('Ã¢ÂÂ ÃÂ¯ÃÂ¸ÃÂ Connecte-toi pour jouer !');return;}
...
const BINGO_CELLS=[
  ...
  {id:7, e:'Ã°ÂÂÂÃÂ¯ÃÂ¸ÃÂ', t:"Lis une anecdote Histoire"},
  {id:8, e:'Ã°ÂÂÂ¨', t:"Lis une anecdote Art"},
  {id:9, e:'Ã°ÂÂÂ¥', t:'3 jours de suite'},
  {id:10,e:'Ã°ÂÂÂ¤', t:"Partage une anecdote"},
  {id:11,e:'Ã°ÂÂÂÃÂ¯ÃÂ¸ÃÂ', t:"Obtiens un badge"},
  {id:12,e:'Ã°ÂÂÂ', t:"Lis une anecdote Espace"},
  {id:13,e:'Ã°ÂÂÂ½ÃÂ¯ÃÂ¸ÃÂ', t:"Lis une anecdote Gastro"},
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃÂ¢ÃÂ
_handleHashRouting();
  window.addEventListener('hashchange',_handleHashRouting);


// ââ BanniÃ¨re site ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
async function loadSiteBanner(){
  try{
    ...
    if(!el){
      el=document.createElement('div');el.id='site-banner';
      document.body.insertBefore(el,document.body.firstChild);
    }
    const colors={info:'#3b82f6',warning:'#f59e0b',success:'#22c55e',error:'#ef4444'};
    const icons={info:'â¹ï¸',warning:'â ï¸',success:'â',error:'ð¨'};
    ...
    el.innerHTML='<span>'+(icons[b.type]||'â¹ï¸')+'</span><span>'+b.message+'</span><button onclick="this.closest('#site-banner').style.display='none'" style="margin-left:.75rem;background:none;border:none;cursor:pointer;color:'+c+';font-size:1rem;line-height:1;opacity:.7">â</button>';
    document.documentElement.style.setProperty('--banner-h','38px');
  }catch(e){}
}
// Auto-call after auth init settles
...
async function loadSiteBanner(){
  try{
    ...
    const c=colors[b.type]||colors.info;
    el.style.cssText='position:fixed;top:0;left:0;right:0;z-index:9999;padding:.6rem 1rem;background:'+c+'18;border-bottom:2px solid '+c+';display:flex;align-items:center;justify-content:center;gap:.6rem;font-size:.82rem;font-weight:600;color:'+c;
    const icon=document.createElement('span');icon.textContent=icons[b.type]||'ℹ️';
    const msg=document.createElement('span');msg.textContent=b.message;
