...
const ONBOARD_SLIDES=[
  ...
  {wolf:'=�',title:'Lisez & Apprenez',desc:'Gagnez des XP en lisant et en r�pondant aux quiz. Montez de niveau et d�bloquez des badges !'},
  {wolf:'<�',title:'D�fiez vos amis',desc:'Ajoutez des amis, comparez vos scores dans la ligue hebdomadaire et grimpez au classement !'}
];
let _onboardStep=0;
...
export function showHunterToast(username){
  ...
  t.innerHTML='<span class="hunter-toast-ico">�</span><div><div class="hunter-toast-title">Nouveau chasseur d�tect�</div><div class="hunter-toast-name">'+username+' a rejoint le Syst�me</div></div>';
  t.classList.add('on');
  clearTimeout(t._tmr);
