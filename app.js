...
async function showMysteryDetail(){
  ...
  if(!sc){sc=document.createElement('div');sc.id='screen-mystery';sc.className='screen';const ref=[...document.querySelectorAll('.screen')].find(el=>el.parentNode===document.body);ref?document.body.insertBefore(sc,ref):const _mf=document.getElementById('chat-footer')||document.querySelector('footer,nav');if(_mf)document.body.insertBefore(sc,_mf);else document.body.appendChild(sc);}
